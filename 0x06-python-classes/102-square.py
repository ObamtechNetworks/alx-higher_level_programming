...
class Square:
    ...
    def __eq__(self, other):
        """compares the equality of areas of two square instances
    ...
    def __ne__(self, other):
        """compares the inequality of areas of two square instances
    ...
    def __gt__(self, other):
        """compares the largenes of areas of two square instances
    ...
    def __ge__(self, other):
        """compares the >=  of areas of two square instances
    ...
    def __lt__(self, other):
        """compares the less than  of areas of two square instances
